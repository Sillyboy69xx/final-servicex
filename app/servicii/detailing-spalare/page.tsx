...
export default function DetailingPage() {
  return (
    <>
      ...
      <ServiceHero
        title={"DETAILING\n& SPĂLARE"}
        intro="Recondiționarea interiorului și exteriorului masinii. Lucrăm cu produse profesionale."
                  ...
                  <div className="grid md:grid-cols-12 gap-8">
                    <div className="md:col-span-7">
                      ...
                      <p className="text-text-muted leading-relaxed mb-8">
                        Curățarea și recondiționarea interiorului la aspect
                        impecabil. Fiecare element este tratat cu produsul
                        potrivit, fără compromisuri pentru materiale delicate.
                      </p>
                      <ul className="space-y-3">
                        {interiorList.map((it) => (
                          ...
                          >
                            <span className="font-heading text-accent-primary text-lg">
                              /
                            </span>
                            <span>{it}</span>
                          </li>
                    ...
                    <div className="md:col-span-5">
                      ...
                      <p className="text-text-muted leading-relaxed">
                        Identificăm tipul fiecărei suprafețe înainte să aplicăm
                        orice produs. Pielea naturală, tapițeria din alcantara,
                        plasticele moi — toate cer abordări diferite.
                      </p>
                    </div>
                  </div>
                </ScrollReveal>
                ...
                <ScrollReveal>
                  <div className="grid md:grid-cols-12 gap-8">
                    <div className="md:col-span-7">
                      ...
                      <p className="text-text-muted leading-relaxed mb-8">
                        De la spălare corectă, la decontaminare, corecție și
                        protecție ceramică ONE EVO. Lucrăm pentru un finisaj
                        care durează, nu pentru efect de o zi.
                      </p>
                      <ul className="space-y-3">
                        {exteriorList.map((it) => (
                          <li
                    ...
                    <div className="md:col-span-5">
                      ...
                      <p className="text-text-muted leading-relaxed">
                        Protecția ceramică ONE EVO oferă rezistență reală la
                        zgârieturi minore, ușurință la întreținere și un luciu
                        profund care rămâne luni de zile.
                      </p>
                    </div>
                  </div>
                </ScrollReveal>
                ...
                <ScrollReveal>
                  <div className="grid md:grid-cols-12 gap-8">
                    <div className="md:col-span-7">
                      ...
                      <p className="text-text-muted leading-relaxed mb-8">
                        Ideal pentru un refresh vizibil și o curățare corectă a
                        exteriorului. Îndepărtează murdăria persistentă, redă
                        luciul natural al vopselei și oferă un strat de
                        protecție hidrofobă de durată.
                      </p>
                      <ul className="space-y-3">
                        {spalareList.map((it) => (
                          <li
                    ...
                    <div className="md:col-span-5">
                      ...
                      <p className="text-text-muted leading-relaxed">
                        Folosim metoda celor două găleți, microfibre noi și
                        produse cu pH neutru. Fără perii dure, fără spălătorii
                        cu role.
                      </p>
                    </div>
                  </div>
      ...
      <section className="bg-bg-secondary border-y border-border-dark/10 py-16 md:py-24">
        <div className="container-x">
          ...
          {/* Before/after sliders first; before/after sources swapped to invert slider sides */}
          ...
          {/* Descriptive copy sits below the comparison images */}
          <p className="text-text-muted leading-relaxed max-w-3xl mt-10 md:mt-14">
            Lucrăm pe etape, măsurăm grosimea lacului, alegem polish-ul corect
            pentru fiecare pasaj. Trage de buton stânga-dreapta pentru a vedea
            diferența.
          </p>
        </div>
      </section>
