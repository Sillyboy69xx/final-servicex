    ...
    <footer className="bg-bg-secondary border-t border-border-dark/15 mt-16 md:mt-24">
      <div className="container-x py-14 md:py-20">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-16">
          <div>
            ...
            <p className="text-text-muted text-sm leading-relaxed max-w-xs">
              Pregătim mașini pentru locuri unde drumul se termină. Fiecare proiect este personal.
            </p>
          ...
          <div>
            <h3 className="font-heading text-xl tracking-widest mb-5">Servicii</h3>
          ...
          <div>
            <h3 className="font-heading text-xl tracking-widest mb-5">Companie</h3>
            <ul className="space-y-2.5 mb-6">
              <li><Link href="/despre-noi" className="text-sm text-text-muted hover:text-accent-primary">Despre noi</Link></li>
              <li><Link href="/galerie" className="text-sm text-text-muted hover:text-accent-primary">Galerie build-uri</Link></li>
              <li><Link href="/servicii" className="text-sm text-text-muted hover:text-accent-primary">Toate serviciile</Link></li>
            </ul>
            <h3 className="font-heading text-xl tracking-widest mb-4">Contact</h3>
            <ul className="space-y-3 text-sm">
              <li>
                <a href={`tel:${siteConfig.phoneRaw}`} className="flex items-center gap-2.5 hover:text-accent-primary">
                  <Phone className="w-4 h-4" /> {siteConfig.phone}
                </a>
              </li>
              <li>
                <a href={`mailto:${siteConfig.email}`} className="flex items-center gap-2.5 text-text-muted hover:text-accent-primary">
        ...
        <div className="mt-12 pt-6 border-t border-border-dark/15 flex flex-col md:flex-row md:items-center md:justify-between gap-3 text-xs text-text-muted">
          ...
          <p className="font-accent text-base">o mașină nu se reparӑ — se cunoaște.</p>
        </div>
      </div>
    </footer>
  )
